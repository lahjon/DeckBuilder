...
public class ConditionTypeInfo
{
    ...
    public static ConditionTypeInfo HasAlly = new ConditionTypeInfo { baseText = "Currently only used for enemies" };
    public static ConditionTypeInfo HasNoAlly = new ConditionTypeInfo { baseText = "Currently only used for enemies" };
    ...
    private static Dictionary<ConditionType, ConditionTypeInfo> ConditionInfos = new Dictionary<ConditionType, ConditionTypeInfo> {
        ...
        {ConditionType.HasAlly, HasAlly},
        {ConditionType.HasNoAlly, HasNoAlly},
    };
