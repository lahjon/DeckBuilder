...
public class EffectTypeInfo : IEquatable<EffectTypeInfo>
{
    ...
    public static EffectTypeInfo Barricade = new EffectTypeInfo { effectType = EffectType.Barricade, verb = "Gain", isReversible = true, constructor = () => { return new CardEffectBarricade(); }, toolTipCard = Block.toolTipCard, toolTipIcon = $"<b>Barricade</b>\nBlock is retained between turns", txtOverride = "Block is retained between turns", isOath = true };
    ...
    public static EffectTypeInfo Thorns = new EffectTypeInfo { effectType = EffectType.Thorns, verb = "Gain", isReversible = true, constructor = () => { return new CardEffectThorns(); }, toolTipCard = $"<b>Thorns</b>\nDeal damage back when attacked", toolTipIcon = $"<b>Thorns</b>\nDeal damage back when attacked", isOath = true };
    ...
    public static EffectTypeInfo Strength = new EffectTypeInfo { effectType = EffectType.Strength, verb = "Gain", isReversible = true, constructor = () => { return new CardEffectStrength(); }, toolTipCard = $"<b>Strength</b>\nIncreases the damage of all attacks", toolTipIcon = $"<b>Strength</b>\nIncreases the damage of all attacks", isOath = true };
    ...
    public static EffectTypeInfo Envenom = new EffectTypeInfo { effectType = EffectType.Envenom, verb = "Gain", isReversible = true, constructor = () => { return new CardEffectEnvenom(); }, toolTipCard = $"<b>Envenom</b>\nUnblocked damage inflicts poison.", toolTipIcon = $"<b>Envenom</b>\nUnblocked damage inflicts poison.", isOath = true };
    ...
    public static EffectTypeInfo Barrier = new EffectTypeInfo { effectType = EffectType.Barrier, verb = "Gain", isReversible = true,constructor = () => { return new CardEffectBarrier(); }, toolTipCard = $"<b>Barrier</b>\nNegate the next time you would loose life.", toolTipIcon = $"<b>Barrier</b>\nNegate the next time you would loose life." };
