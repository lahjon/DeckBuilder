...
public class StatusEffectTypeInfo : IEquatable<StatusEffectTypeInfo>
{
    ...
    public CardEffect Constructor() => Helpers.InstanceObject<CardEffect>(type.ToString());
    ...
    public static StatusEffectTypeInfo Splice = new StatusEffectTypeInfo { type = StatusEffectType.Splice, category = StatusEffectCategory.Buff, verb = "Gain", toolTipIcon = $"<b>Splice</b>\nThe next splice card you play will meld with the top splice card in discard" };
    public static StatusEffectTypeInfo Challenge = new StatusEffectTypeInfo { type = StatusEffectType.Challenge, category = StatusEffectCategory.Buff, verb = "Call", txtOverride = "<b>Challenge</b> an Enemy. You deal double damage against eachother.", toolTipIcon = $"<b>Challenge</b>\nChallenged actors deal double damage against eachother", toolTipCard = $"<b>Challenge</b>\nChallenged actors deal double damage against eachother" };
    public static StatusEffectTypeInfo Strength = new StatusEffectTypeInfo { type = StatusEffectType.Strength, category = StatusEffectCategory.Buff, verb = "Gain", toolTipCard = $"<b>Strength</b>\nIncreases the damage of all attacks", toolTipIcon = $"<b>Strength</b>\nIncreases the damage of all attacks" };
    public static StatusEffectTypeInfo StrengthTemp = new StatusEffectTypeInfo { type = StatusEffectType.StrengthTemp, category = StatusEffectCategory.Buff, verb = "Apply", toolTipIcon = $"<b>StrengthTemp</b>\nTemporarily changes strength during your turn", toolTipCard = Strength.toolTipCard };
    ...
    public static StatusEffectTypeInfo Spiked = new StatusEffectTypeInfo { type = StatusEffectType.Spiked, category = StatusEffectCategory.Buff, verb = "Apply", toolTipIcon = $"<b>Spiked</b>\nUntil your next turn, retailate when attacked.", toolTipCard = $"<b>Spiked</b>\nUntil your next turn, retailate when attacked." };
    public static StatusEffectTypeInfo Barrier = new StatusEffectTypeInfo { type = StatusEffectType.Barrier, category = StatusEffectCategory.Buff, verb = "Gain", toolTipCard = $"<b>Barrier</b>\nNegate the next time you would loose life.", toolTipIcon = $"<b>Barrier</b>\nNegate the next time you would loose life." };
    public static StatusEffectTypeInfo Steaming = new StatusEffectTypeInfo { type = StatusEffectType.Steaming, category = StatusEffectCategory.Buff,  verb = "Gain",  toolTipIcon = $"<b>Steaming</b>\nUntil next turn, gain Rage when attacked.", toolTipCard = $"<b>Steaming</b>\nUntil next turn, gain Rage when attacked." };
    public static StatusEffectTypeInfo Loaded = new StatusEffectTypeInfo { type = StatusEffectType.Loaded, category = StatusEffectCategory.Buff, toolTipIcon = $"<b>Loaded</b>\nNext attack deals double damage.", txtOverride = "Your next attack deals double damage" };
